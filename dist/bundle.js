	...
	var App = function () {
	    ...
	    _createClass(App, [{
	        ...
	        value: function renderDOM() {
	            this.page = new _Page2.default(this);
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _backbone.Router.extend({
	    ...
	    initialize: function initialize() {
	        ...
	        _backbone.Events.on('changeState:router', function (eventObj) {
	            _this.setState(eventObj);
	        });
	    },
	    routeHandler: function routeHandler(menu, tab, query) {
	        this.setState({
	            menu: menu,
	            tab: tab,
	            query: query
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SideMenu = __webpack_require__(11);
	...
	exports.default = _backbone.View.extend({
	    el: 'body',
	    template: _.template(_view2.default),
	    children: [_SideMenu2.default, _Tabs2.default, _Content2.default],
	    initialize: function initialize() {
	        this.render();
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _backbone.View.extend({
	    ...
	    template: _.template(_menu2.default),
	    initialize: function initialize() {
	        this.render();
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _backbone.Collection.extend({
	    ...
	    initialize: function initialize() {
	        ...
	        this.DataStorage = new _Helpers.DataStorage();
	        this.add(this.DataStorage.getMenu());

	        _backbone.Events.on('stateChanged:router', function (eventObj) {
	            if (eventObj.menu) {
	                _this.map(function (model) {
	                    return model.toggleState(model.get('slug') == eventObj.menu);
	                });
	            }
	        });
	    },
	    setActive: function setActive(id) {
	        ...
	        _backbone.Events.trigger('changeState:router', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataStorage = exports.DataStorage = function () {
	    function DataStorage() {
	        ...
	        this.data = _content2.default[0];
	    }

	    _createClass(DataStorage, [{
	        key: "getDefaultTabSlug",
	        value: function getDefaultTabSlug(key) {
	            return this.data.tabs.hasOwnProperty(key) ? this.data.tabs[key][0].slug : {};
	        }
	    }, {
	        key: "getTabs",
	        value: function getTabs(key) {
...
/***/ function(module, exports) {
	...
	module.exports = "<ul class=\"side-menu-nav\">\n    <% for(var item in menuItems) { %>\n    <li class=\"<%= menuItems[item].active ? 'active' : '' %>\">\n        <a href=\"/<%= menuItems[item].slug %>\" id=\"<%= menuItems[item].id %>\"><%= menuItems[item].title %></a>\n    </li>\n    <% } %>\n</ul>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./menu.styl", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./menu.styl");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _backbone.View.extend({
	    el: '#main-content',
	    template: _underscore2.default.template(_view2.default),
	    children: [_Accordion2.default],
	    initialize: function initialize() {
	        this.render();
	        this.children.forEach(function (child) {
	            return new child();
...
/***/ function(module, exports) {
	...
	module.exports = "<div id=\"accourdion\" class=\"collapse\"></div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _backbone.View.extend({
	    ...
	    toggle: function toggle(event) {
	        ...
	        _backbone.Events.trigger('changeState:router', { query: this.collection.getAllOpened() });
	    },
	    render: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _backbone.Collection.extend({
	    ...
	    initialize: function initialize() {
	        ...
	        _backbone.Events.on('stateChanged:router', function (eventObj) {
	            if (eventObj.tab && eventObj.tab.replace('/', '') != _this.parent) {
	                _this.parent = eventObj.tab.replace('/', '');
	                _this.reset(_this.DataStorage.getContent(_this.parent));
	            }

	            if (eventObj.query) {
	                _this.setDefaults(eventObj.query);
	            }
	        });
	    },
	    setToggle: function setToggle(id) {
	    ...
	    setDefaults: function setDefaults(query) {
	        ...
	        if (query) {
	            query.split(',').forEach(function (id) {
	                return _this2.get(id) ? _this2.get(id).toggleState() : null;
	            });
	            this.reset(this.models);
	        }
	    },
	    getAllOpened: function getAllOpened() {
...
/***/ function(module, exports) {
	...
	module.exports = "<% for(var item in content ) { %>\n<div class=\"collapse-item <%= (content[item].toggle ? 'opened' : '') %>\">\n    <h3 class=\"collapse-title\" id=\"<%= content[item].id %>\"><%= content[item].title %></h3>\n    <div class=\"collapse-body\"><%= content[item].body %></div>\n</div>\n<% } %>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _backbone.Collection.extend({
	    ...
	    initialize: function initialize() {
	        ...
	        _backbone.Events.on('stateChanged:router', function (eventObj) {
	            if (eventObj.menu && eventObj.menu.replace('/', '') != _this.parent) {
	                _this.parent = eventObj.menu.replace('/', '');
	                _this.reset(_this.DataStorage.getTabs(_this.parent));
	                //this.get(1).toggleState(true)
	            }
	            if (eventObj.tab) {
	                _this.map(function (model) {
	                    return model.toggleState(model.get('slug') == eventObj.tab);
	                });
	            }
	        });
	    },
...
/***/ function(module, exports) {
	...
	module.exports = "<ul class=\"top-menu-nav\">\n    <% for(var item in menuItems) { %>\n    <li class=\"<%= menuItems[item].active ? 'active' : '' %>\">\n        <a href=\"/<%= menuItems[item].slug %>\" id=\"<%= menuItems[item].id %>\"><%= menuItems[item].title %></a>\n    </li>\n    <% } %>\n</ul>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".top-menu-nav li {\n  display: inline-block;\n}\n.top-menu-nav li a {\n  display: block;\n  text-decoration: none;\n  padding: 10px;\n  color: #fff;\n  transition: all 230ms ease-out;\n}\n.top-menu-nav li.active a {\n  background: #1a1a1a;\n  color: #fff;\n}\n.top-menu-nav li:hover a {\n  background: #262626;\n}\n", ""]);
